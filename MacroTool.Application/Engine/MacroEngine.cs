...
public sealed class MacroEngine : IDisposable
{
    ...
    private readonly ITimelineRepository _store;
    private readonly EngineSettings _settings;
    private readonly LogBuffer _logBuffer;
    private readonly ILogger<MacroEngine> _logger;
    private readonly IInputSink _inputSink;
    private readonly Func<IInputCaptureSource> _captureSourceFactory;
    ...
    public MacroEngine(
        ...
        ITimelineRepository store,
        EngineSettings settings,
        LogBuffer logBuffer,
        ILogger<MacroEngine> logger,
        IInputSink inputSink,
        Func<IInputCaptureSource> captureSourceFactory,
        bool isElevated)
    {
        _hotkeys = hotkeys;
        _store = store;
        ...
        _captureSourceFactory = captureSourceFactory;
    ...
    public string TimelinePath => _store.FilePath;
    ...
    public TimelineSaveResult SaveTimeline(MacroTimeline timeline)
    {
        var result = _store.Save(timeline, _settings.Speed);
        if (result.Success)
            ReplaceTimeline(timeline);
        return result;
    }

    public TimelineLoadResult LoadTimelineFromDisk() => _store.Load();
    ...
    private void StartRecordingInternal()
    {
        ...
        _recorder = new Recorder(_captureSourceFactory());
        _recorder.Start();
    ...
    private void StartPlaybackInternal()
    {
        ...
        var player = new Player(timeline!, _settings, _inputSink);
